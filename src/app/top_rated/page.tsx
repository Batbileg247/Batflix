...
export default async function Home({
  ...
  const { top_rated, topRatedPageNum } = await getHomePageMovies(String(page));
          ...
          <PaginationContent>
            <PaginationItem>
              <PaginationPrevious
                ...
                href={page > 1 ? `/top_rated?page=${page - 1}` : "#"}
              />
            </PaginationItem>
            {getPageNumbers.map((pageNumber) => (
              <PaginationItem key={pageNumber}>
                <PaginationLink
                  ...
                  href={`/top_rated?page=${pageNumber}`}
            ...
            <PaginationItem>
              <PaginationNext
                className="dark:text-white dark:bg-neutral-900"
                href={
                  page < topRatedPageNum
                    ? `/top_rated?page=${page + 1}`
                    : "#"
                }
              />
            </PaginationItem>
